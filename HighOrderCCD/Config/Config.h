...
#define FUNCTION_NOT_IMPELEMENTED { \
std::cout << "Function " << __FUNCTION__ << " not implemented in file: " << __FILE__ << " line: " << __LINE__ << "!" << std::endl;   \
exit(EXIT_FAILURE); \
}
...
extern int trajectory_num, piece_num;
extern int res;
extern int iter;
