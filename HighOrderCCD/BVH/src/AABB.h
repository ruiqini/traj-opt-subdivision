...
namespace aabb
{
    ...
    public:
         ...
         */
        bool overlaps(const AABB&, bool touchIsOverlap, double margin) const;
    ...
    public:
         ...
         */
        std::vector<unsigned int> query(unsigned int, double);
        ...
        /*! \param particle
            ...
            \return particles
                A vector of particle indices.
         */
        std::vector<unsigned int> query(unsigned int, const AABB&, double);

        //! Query the tree to find candidate interactions for an AABB.
        /*! \param tree
                The tree.

            \return particles pair
                A vector of particle pair indices.
         */
        std::vector<std::pair<unsigned int,unsigned int>> query(const Tree&, double);
        ...
        /*! \param aabb
            ...
            \return particles
                A vector of particle indices.
         */
        std::vector<unsigned int> query(const AABB&, double);
